 ...
 * evaluated on the server-side. Used during serialization and deserialization
 * to pass Expression between client and server.
 *
 *
 *
 * @since 0.1
...
public enum ExpressionType {
  ...
  /**
   * Return the ExpressionType for a given Expression instance or null if none
   * exists.
   */
