...
public class WriteWorkload implements Workload {
   ...
   * writeParams are used in the config files, they will override the defaults.
   * writeParams are used for read/write mixed workloads. TODO extract notion of
   * the scenario list and have 1 write workload per scenario
   *
   * @param phoenixUtil {@link org.apache.phoenix.pherf.util.PhoenixUtil} Query
   * helper
   * @param properties {@link java.util.Properties} default properties to use
   * @param parser
   * {@link org.apache.phoenix.pherf.configuration.XMLConfigParser}
   * @param scenario {@link org.apache.phoenix.pherf.configuration.Scenario} If
   * null is passed it will run against all scenarios in the parsers list.
   * @throws Exception
   */
