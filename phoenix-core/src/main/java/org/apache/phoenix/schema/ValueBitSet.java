...
/**
 *
 * Class to track whether or not a value is null. The value is a zero-based
 * position in the schema provided.
 *
 *
 * @since 0.1
 *
...
public class ValueBitSet {
  ...
  /**
   * Serialize the value bit set into a byte array. The byte array is expected
   * to have enough room (use {@link #getEstimatedLength()} to ensure enough
   * room exists.
   *
