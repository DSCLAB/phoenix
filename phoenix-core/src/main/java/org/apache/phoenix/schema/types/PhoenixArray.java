...
public class PhoenixArray implements Array, SQLCloseable {
  ...
  /**
   * Return the value in position {@code index} from the underlying array. Used
   * to work around casting and reflection while enabling primitive arrays.
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (numElements != oArray.numElements) {
      return false;
    }
    if (baseType.getSqlType() != oArray.baseType.getSqlType()) {
      return false;
    }
