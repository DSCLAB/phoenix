...
/**
 * Base class for tests that manage their own time stamps We need to separate
 * these from tests that rely on hbase to set timestamps, because we
 * create/destroy the Phoenix tables between tests and only allow a table time
 * stamp to increase. Without this separation table deletion/creation would
 * fail.
 *
