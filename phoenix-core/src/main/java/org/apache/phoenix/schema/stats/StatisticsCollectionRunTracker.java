 ...
 * stats collection at the region server's JVM level.
 */
public class StatisticsCollectionRunTracker {
  ...
  /**
   * @param regionInfo for the region that should be marked as undergoing stats
   * collection via major compaction.
   * @return true if the region wasn't already marked for stats collection via
   ...
   * stats collection via major compaction.
   * @return true if the region was marked for stats collection via compaction,
   * false otherwise.
   */
  ...
  /**
   * @param regionInfo for the region to mark as not running UPDATE STATISTICS
   * command on.
