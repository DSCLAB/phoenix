...
public class TestSimpleWriterIndexCommitter {

  private static final Log LOG = LogFactory.getLog(TestSimpleWriterIndexCommitter.class);
  @Rule
  ...
  public void testCorrectlyCleansUpResources() throws Exception{
    ...
    SimpleWriterIndexCommitter writer = new SimpleWriterIndexCommitter(VersionInfo.getVersion());
    ...
    writer.setup(factory, mockAbort, mockStop, 1, e);
    // stop the writer
  ...
  public void testSynchronouslyCompletesAllWrites() throws Exception {
    ...
    Map<ImmutableBytesPtr, HTableInterface> tables = new HashMap<>();
    ...
    SimpleWriterIndexCommitter writer = new SimpleWriterIndexCommitter(VersionInfo.getVersion());
    writer.setup(factory, abort, stop, 1, e);
    writer.write(indexUpdates, true);
    assertTrue("Writer returned before the table batch completed!", completed[0]);
    writer.stop(this.test.getTableNameString() + " finished");
    assertTrue("Factory didn't get shutdown after writer#stop!", factory.shutdown);
  }
}