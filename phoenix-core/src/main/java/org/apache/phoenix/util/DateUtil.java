...
public class DateUtil {
   ...
   * constructor. This method takes the milli-seconds that spills over to the
   * nanos part as part of constructing the {@link Timestamp} object. If we just
   * set the nanos part of timestamp to the nanos passed in param, we end up
   * losing the sub-second part of timestamp.
   */
  ...
  /**
   * Utility function to convert a {@link BigDecimal} value to
   * {@link Timestamp}.
   */
  ...
  /**
   * This class is used when a user explicitly provides phoenix.query.dateFormat
   * in configuration
   */
