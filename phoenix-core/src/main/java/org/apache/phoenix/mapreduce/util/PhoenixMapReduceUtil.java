...
public final class PhoenixMapReduceUtil {
   ...
   * @param conditions Condition clause to be added to the WHERE clause. Can be
   * <tt>null</tt> if there are no conditions.
  ...
  /**
   * A method to override which HBase cluster for {@link PhoenixInputFormat} to
   * read from
   *
  ...
  /**
   * A method to override which HBase cluster for {@link PhoenixOutputFormat} to
   * write to
   *
   * @param job MapReduce Job
   * @param quorum an HBase cluster's ZooKeeper quorum
