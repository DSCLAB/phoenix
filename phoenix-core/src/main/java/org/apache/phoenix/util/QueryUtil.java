...
public final class QueryUtil {
  ...
  /**
   * Index of the column containing the datatype name within ResultSet resulting
   * from {@link
  ...
  /**
   * Generate an upsert statement based on a list of {@code ColumnInfo}s with
   * parameter markers. The list of {@code ColumnInfo}s must contain at least
   * one element.
   *
   * @param tableName name of the table for which the upsert statement is to be
   * created
  ...
  /**
   * Generate a generic upsert statement based on a number of columns. The
   * created upsert statement will not include any named columns, but will
   * include parameter markers for the given number of columns. The number of
  ...
  /**
   *
   * @param fullTableName name of the table for which the select statement needs
   * to be created.
  ...
  /**
   * Create the Phoenix JDBC connection URL from the provided cluster connection
   * details.
   */
