...
public class QueryUtilTest {
  ...
  /**
   * Test that we create connection strings from the HBase Configuration that
   * match the expected syntax. Expected to log exceptions as it uses ZK host
  ...
  private void validateUrl(String url) {
    ...
    assertEquals("More than a single ':' in url: " + url, url.indexOf(PhoenixRuntime.JDBC_PROTOCOL_SEPARATOR),
