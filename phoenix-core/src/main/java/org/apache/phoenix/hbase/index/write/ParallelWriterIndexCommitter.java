...
/**
 * Write index updates to the index tables in parallel. We attempt to early exit
 * from the writes if any of the index updates fails. Completion is determined
 ...
 * </ol>
 * We attempt to quickly determine if any write has failed and not write to the
 * remaining indexes to ensure a timely recovery of the failed index writes.
 */
