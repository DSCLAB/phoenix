...
public class RowKeyValueAccessor implements Writable {
  ...
  /**
   * Constructor solely for use during deserialization. Should not otherwise be
   * used.
   */
  ...
  /**
   * Constructor to compile access to the value in the row key formed from a
   * list of PData.
   *
  ...
  /**
   * Calculate the byte offset in the row key to the start of the PK column
   * value
   *
