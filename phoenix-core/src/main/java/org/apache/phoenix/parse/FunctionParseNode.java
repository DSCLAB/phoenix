...
public class FunctionParseNode extends CompoundParseNode {
  ...
  /**
   * Determines whether or not we can collapse a function expression to null if
   * a required parameter is null.
   *
   * @param context
   * @param index index of parameter
   * @return true if when the parameter at index is null, the function always
   * evaluates to null and false otherwise.
   * @throws SQLException
   */
  ...
  /**
   * Entry point for parser to instantiate compiled representation of built-in
   * function
   *
   * @param children Compiled expressions for child nodes
   * @param context Query context for accessing state shared across the
   * processing of multiple clauses
  ...
  /**
   * Marker used to indicate that a class should be used by
   * DirectFunctionExpressionExec below
   */
  ...
  /**
   * Structure used to hold parse-time information about Function implementation
   * classes
   */
  @Immutable
