 ...
 *
 * TODO: get rid of this ugly code and just go through the standard APIs. The
 * only time we may still need this is to manage updating the empty key value,
 * as we sometimes need to "go back through time" to adjust this.
 *
 * @since 0.1
 */
