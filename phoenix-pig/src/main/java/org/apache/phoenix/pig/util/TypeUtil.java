...
public final class TypeUtil {
   ...
   * incoming Pig type. Note for Pig DataType DATETIME, returns DATE as
   * inferredSqlType. This is later used to make a cast to targetPhoenixType
   * accordingly. See {@link #castPigTypeToPhoenix(Object, byte, PDataType)}
   *
   * @param obj
   * @return PDataType
   */
  ...
  /**
   * This method encodes a value with Phoenix data type. It begins with checking
   * whether an object is TUPLE. A {@link Tuple} is mapped to a
   * {@link PArrayDataType} . It then checks if it is BINARY and makes a call to
   * {@link #castBytes(Object, PDataType)} to convert bytes to
   * targetPhoenixType. It returns a {@link RuntimeException} when object can
   * not be coerced.
   *
   * @param o
   ...
   * {@link HBaseBinaryConverter} for the conversion.
   *
   * @param o
   * @param targetPhoenixType
   * @return Object
