...
/**
 * Function used to bucketize date/time values by rounding them to an even
 * increment. Usage:
 ...
 * time unit (i.e. 10 minute rollup) The function returns a
...
public class RoundDateExpression extends ScalarFunction {
   ...
   * {@link RoundDateExpression} with default multiplier of 1.
   */
  ...
  /**
   * Form the key range from the key to the key right before or at the next
   * rounded value.
   */
  @Override
