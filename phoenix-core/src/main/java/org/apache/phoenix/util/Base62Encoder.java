...
/**
 * Utility for converting a base 10 number to string that represents a base 62
 * number
 */
public class Base62Encoder {
   ...
   *
   * @param num must be a positive number
   */
  ...
  /**
   * Fills the given buffer with a string representing the given number in base
   * 62. The characters are placed into the buffer backwards starting with the
   * least significant digit and working backwards from there.
   *
   * @param num number to convert, should be > Long.MIN_VALUE
   * @param size size of the buffer
   * @param buf buffer to place encoded string
   */
