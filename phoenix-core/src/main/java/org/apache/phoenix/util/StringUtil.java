...
public class StringUtil {
   ...
   * Src and target are not regex's so this uses simple searching with indexOf()
   */
   ...
   * @param b1
   * @param b2
   * @return whether or not the two builders consist the same sequence of
   * characters
   */
   ...
   * @param strWithPaddingLen length of the string that is returned with fill
   * values left padded
  ...
  /**
   * Assigns the specified byte values to elements of the specified range of the
   * specified array of bytes. The range to be filled extends from index
   ...
   * @param strFromIdx the index of the first element (inclusive) to be filled
   * with the fill values
   * @param strToIdx the index of the last element (exclusive) to be filled with
   * the fill values
   * @param fillArray the values to be stored in all elements of the array
   * @param fillFromIdx the index of the first element (inclusive) to be used as
   * fill values
   * @param filToIdx the index of the last element (exclusive) to be used as
   * fill value
   * @param invertFill if true inverts the bits in fill before filling the array
   */
  ...
  /**
   * Checks that fromIndex and toIndex are in the range and throws an
