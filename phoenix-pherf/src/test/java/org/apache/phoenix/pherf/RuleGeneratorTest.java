...
public class RuleGeneratorTest {
   ...
   * {@link org.apache.phoenix.pherf.configuration.DataSequence} SEQUENTIAL It
   * ensures values returned always increase uniquely. RulesApplier will be
   * accessed by multiple writer so we must ensure increment is thread safe.
   */
