...
public class QuerySet {
  ...
  /**
   * Target concurrency. This can be set as a range. Example: 3 1-4
   *
   * @return
   */
  @XmlAttribute
  ...
  /**
   * Number of execution of query per thread. Minimum of either number of
   * executions or execution duration is taken for each thread run
   *
   * @return
   */
  @XmlAttribute
  ...
  /**
   * Execution duration of query per thread. Minimum of either number of
   * executions or execution duration is taken for each thread run
   *
   * @return
   */
