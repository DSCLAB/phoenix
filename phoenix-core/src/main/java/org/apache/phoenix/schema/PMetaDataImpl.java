...
/**
 * Client-side cache of MetaData, not thread safe. Internally uses a
 * LinkedHashMap that evicts the oldest entries when size grows beyond the
 * maxSize specified at create time.
 */
