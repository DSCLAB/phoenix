...
/**
 *
 * Interface to encapsulate both the client-side name together with the
 * server-side name for a named object
 *
 *
 * @since 0.1
 */
public interface PName {
  ...
  /**
   * Get the server-side name as referenced in HBase-related APIs such as Scan,
   * Filter, etc.
   *
