...
/**
 * A SequenceKey and the number of slots requested to be allocated for the
 * sequence. It binds these two together to allow operations such as sorting a
 * Collection of SequenceKeys and at the same time preserving the associated
 * requested number of slots to allocate.
 *
