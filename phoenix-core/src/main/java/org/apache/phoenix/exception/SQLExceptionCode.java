...
/**
 * Various SQLException Information. Including a vender-specific errorcode and a
 * standard SQLState.
 *
 *
 * @since 1.0
...
public enum SQLExceptionCode {
  ...
  /**
   * HBase and Phoenix specific implementation defined sub-classes. Column
  ...
  /**
   * Implementation defined class. Execution exceptions (errorcode 11, sqlstate
   * XCL).
   */
