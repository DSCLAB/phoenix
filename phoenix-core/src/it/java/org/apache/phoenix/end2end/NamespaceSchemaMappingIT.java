...
public class NamespaceSchemaMappingIT extends BaseHBaseManagedTimeIT {
  ...
  /**
   * Tests that when: There is a table created with older version of phoenix and
   * a table created with newer version having
   * {@code QueryServices#IS_NAMESPACE_MAPPING_ENABLED} true, then there is only
   * a flag {@code PhoenixDatabaseMetaData#IS_NAMESPACE_MAPPED} differentiates
   * that whether schema of the table is mapped to namespace or not
   */
  @Test
