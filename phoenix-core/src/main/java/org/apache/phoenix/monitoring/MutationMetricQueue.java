...
public class MutationMetricQueue {
  ...
  /**
   * Publish the metrics to wherever you want them published. The internal state
   * is cleared out after every publish.
   *
  ...
  /**
   * Class to represent a no-op mutation metric. Used in places where request
   * level metric tracking for mutations is not needed or desired.
   */
