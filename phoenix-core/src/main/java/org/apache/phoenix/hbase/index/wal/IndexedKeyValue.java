...
public class IndexedKeyValue extends KeyValue {
  ...
  /**
   * This is a very heavy-weight operation and should only be done when
   * absolutely necessary - it does a full serialization of the underyling
   * mutation to compare the underlying data.
   */
  @Override
   ...
   * special prefixing. Writing should be done via
   * {@link KeyValueCodec#write(DataOutput, KeyValue)} to ensure consistent
   * reading/writing of {@link IndexedKeyValue}s.
   *
  ...
  /**
   * This method shouldn't be used - you should use
   * {@link KeyValueCodec#readKeyValue(DataInput)} instead. Its the complement
   * to {@link #writeData(DataOutput)}.
   */
