...
/**
 * JDBC PreparedStatement implementation of Phoenix. Currently only the
 * following methods (in addition to the ones supported on
 * {@link PhoenixStatement} are supported: - {@link #executeQuery()} - {@link #setInt(int, int)} -
