...
/**
 *
 * JDBC ResultSet implementation of Phoenix. Currently only the following data
 * types are supported: - String - Date - Time - Timestamp - BigDecimal - Double
 * - Float - Int - Short - Long - Binary - Array - 1D None of the update or
 * delete methods are supported. The ResultSet only supports the following
