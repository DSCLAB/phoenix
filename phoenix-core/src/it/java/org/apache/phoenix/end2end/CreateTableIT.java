...
public class CreateTableIT extends BaseClientManagedTimeIT {
   ...
   * value columns have different column family names 3) TTL specifier doesn't
   * have column family name.
   *
  ...
  /**
   * Tests that when: 1) DDL has both pk as well as key value columns 2) Key
   * value columns have both default and explicit column family names 3) TTL
   * specifier doesn't have column family name.
   *
   * Then: 1)TTL is set. 2)All column families have the same TTL.
   */
  @Test
  ...
  /**
   * Tests that when: 1) DDL has both pk as well as key value columns 2) Key
   * value columns have both default and explicit column family names 3)
   * Replication scope specifier has the explicit column family name.
   *
   * Then: 1)REPLICATION_SCOPE is set. 2)The default column family has
   * DEFAULT_REPLICATION_SCOPE. 3)The explicit column family has the
   * REPLICATION_SCOPE specified in DDL.
   */
  @Test
  ...
  /**
   * Tests that when: 1) DDL has both pk as well as key value columns 2) Key
   * value columns have explicit column family names 3) Different
   * REPLICATION_SCOPE specifiers for different column family names.
   *
   * Then: 1)REPLICATION_SCOPE is set. 2)Each explicit column family has the
  ...
  /**
   * Tests that when: 1) DDL has both pk as well as key value columns 2) There
   * is a default column family specified.
   *
  ...
  /**
   * Tests that when: 1) DDL has only pk columns 2) There is a default column
   * family specified.
   *
   * Then: 1)TTL is set for the specified default column family.
   *
  ...
  /**
   * Test to ensure that NOT NULL constraint isn't added to a non primary key
   * column.
   *
   * @throws Exception
   */
