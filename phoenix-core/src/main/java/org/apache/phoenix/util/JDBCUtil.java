...
public class JDBCUtil {
  ...
  /**
   * Find the propName by first looking in the url string and if not found, next
   * in the info properties. If not found, null is returned.
   *
  ...
  /**
   * Returns a map that contains connection properties from both
   * <code>info</code> and <code>url</code>.
   */
   ...
   * @param defaultValue default to return if the auto-commit property is not
   * set in the url or connection properties
   * @return the boolean value supplied for the AutoCommit in the connection URL
   * or properties, or the supplied default value if no AutoCommit attribute was
   * provided
   */
  ...
  /**
   * Retrieve the value of the optional consistency read setting from JDBC url
   * or connection properties.
   *
   * @param url JDBC url used for connecting to Phoenix
   * @param info connection properties
   * @param defaultValue default to return if ReadConsistency property is not
   * set in the url or connection properties
   * @return the boolean value supplied for the AutoCommit in the connection URL
   * or properties, or the supplied default value if no AutoCommit attribute was
   * provided
