...
public class OrderByCompiler {
  ...
  public static class OrderBy {
    ...
    /**
     * Used to indicate that there was an ORDER BY, but it was optimized out
     * because rows are already returned in this order.
     */
   ...
   *
   * @param context the query context for tracking various states associated
   * with the given select statement
