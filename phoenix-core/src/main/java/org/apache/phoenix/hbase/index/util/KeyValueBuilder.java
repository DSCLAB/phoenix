...
public abstract class KeyValueBuilder {
  ...
  /**
   * Helper method for a {@link KeyValueBuilder} that catches an IOException
   * from a {@link Put} when adding a {@link KeyValue} generated by the
   * KeyValueBuilder.
   *
   * @throws RuntimeException if there is an IOException thrown from the
   * underlying {@link Put}
   */
  ...
  /**
   * Compare the qualifier based on the type of keyvalue. Assumes that the
   * {@link KeyValue} passed in was generated by the {@link KeyValueBuilder}
   *
   ...
   * @return the byte difference between the passed keyvalue's qualifier and the
   * passed key
   */
