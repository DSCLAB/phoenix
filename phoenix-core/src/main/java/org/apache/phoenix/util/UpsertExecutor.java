 ...
 * incoming {@code RECORDS}. An {@link UpsertListener} is notified each time the
...
public abstract class UpsertExecutor<RECORD, FIELD> implements Closeable {
  ...
  public interface UpsertListener<RECORD> {
     ...
     *
     * @param record the JSON record that was being upserted when the error
     * occurred
     */
   ...
   * context before proceeding to record processing.
   */
