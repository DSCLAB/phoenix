...
public class PhoenixHBaseStorerIT extends BasePigIT {
  ...
  /**
   * Basic test - writes specific columns data to a Phoenix table and compares
   * the data written to expected
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Test storage of DataByteArray columns to Phoenix Maps the DataByteArray
   * with the target PhoenixDataType and persists in HBase.
   *
   * @throws Exception
   */
  @Test
