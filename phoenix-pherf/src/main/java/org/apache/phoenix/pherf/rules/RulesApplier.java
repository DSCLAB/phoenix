...
public class RulesApplier {
   ...
   *
   * @param scenario {@link org.apache.phoenix.pherf.configuration.Scenario} We
   * are getting data for
   * @param phxMetaColumn {@link org.apache.phoenix.pherf.configuration.Column}
   * From Phoenix MetaData that are generating data for. It defines the type we
   * are trying to match.
   * @return
   * @throws Exception
   */
   ...
   *
   * @param column {@link org.apache.phoenix.pherf.configuration.Column} Column
   * rule to get data for
  ...
  /**
   * Given an int chance [0-100] inclusive, this method will return true if a
   * winner is selected, otherwise false.
   *
  ...
  /**
   * Top level {@link java.util.List} {@link java.util.Map}. This will likely
   * only have one entry until we have multiple files.
   * <p/>
   * <p/>
   * Each Map entry in the List is: {@link java.util.Map} of
   * {@link org.apache.phoenix.pherf.configuration.DataTypeMapping} --> List of {@link org.apache.phoenix.pherf.configuration.Column
   * Build the initial Map with all the general rules.
   * These are contained in:
   * <datamode><datamapping><column>...</column></datamapping></datamode>
   * <p/>
   * <p/>
   * Unsupported until V2 Build the overrides by appending them to the list of
   * rules that match the column type
   */
