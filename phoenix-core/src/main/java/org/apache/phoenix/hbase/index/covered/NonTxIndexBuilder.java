...
public class NonTxIndexBuilder extends BaseIndexBuilder {
   ...
   * <tt>true</tt> if we should should attempt to cleanup the current state of
   * the table, in the event of a 'back in time' batch. <tt>false</tt> indicates
   * we should not attempt the cleanup, e.g. an earlier batch already did the
   * cleanup.
   * @param indexMetaData TODO
   ...
   * {@link IndexCodec#getIndexDeletes(TableState, IndexMetaData)} and then add
   * them to the update map.
   * <p>
