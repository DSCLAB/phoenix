...
public class SequenceManager {
  ...
  /**
   * If caller specified used NEXT <n> VALUES FOR <seq> expression then we have
   * set the numToAllocate. If numToAllocate is > 1 we treat this as a bulk
   * reservation of a block of sequence slots.
   *
