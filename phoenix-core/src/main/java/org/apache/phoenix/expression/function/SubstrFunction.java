 ...
 * where <offset> is the offset from the start of <string>. A positive offset is
 * treated as 1-based, a zero offset is treated as 0-based, and a negative
...
@BuiltInFunction(name = SubstrFunction.NAME, args = {
  ...
  , // These are LONG because negative numbers end up as longs
