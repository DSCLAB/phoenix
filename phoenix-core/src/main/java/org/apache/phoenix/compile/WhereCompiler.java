...
public class WhereCompiler {
  ...
  /**
   * Pushes where clause filter expressions into scan by building and setting a
   * filter.
   *
   * @param context the shared context during query compilation
   * @param statement TODO
   * @throws SQLException if mismatched types are found, bind value do not match
   * binds, or invalid function arguments are encountered.
   * @throws SQLFeatureNotSupportedException if an unsupported expression is
   * encountered.
