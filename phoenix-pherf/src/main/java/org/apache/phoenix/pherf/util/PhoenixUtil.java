...
public class PhoenixUtil {
   ...
   * {@link PherfConstants#PHERF_SCHEMA_NAME} with regex comparison
   *
   * @param regexMatch
   * @throws SQLException
   * @throws Exception
  ...
  /**
   * Execute all querySet DDLs first based on tenantId if specified. This is
   * executed first since we don't want to run DDLs in parallel to executing
   * queries.
   *
   * @param querySet
   * @throws Exception
  ...
  /**
   * Executes any ddl defined at the scenario level. This is executed before we
   * commence the data load.
   *
   * @throws Exception
   */
