...
public class InstanceResolver {
  ...
  /**
   * Resolves an instance of the specified class if it has not already been
   * resolved.
   *
   * @param clazz The type of instance to resolve
   * @param defaultInstance The instance to use if a custom instance has not
   * been registered
   * @return The resolved instance or the default instance provided.
   * {@code null} if an instance is not registered and a default is not
   * provided.
   */
   ...
   * instances will be added to the existing contents of defaultInstances
   */
  @SuppressWarnings("unchecked")
