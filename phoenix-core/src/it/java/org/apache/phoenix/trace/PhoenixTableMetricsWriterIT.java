...
public class PhoenixTableMetricsWriterIT extends BaseTracingTestIT {
  ...
  /**
   * IT should create the target table if it hasn't been created yet, but not
  ...
  /**
   * Simple metrics writing and reading check, that uses the standard wrapping
   * in the {@link PhoenixMetricsSink}
   *
   * @throws Exception on failure
   */
  @Test
