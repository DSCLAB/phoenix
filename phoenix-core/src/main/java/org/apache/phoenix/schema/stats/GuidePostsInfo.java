...
public class GuidePostsInfo {
   ...
   * guidePosts depth is reached while collecting stats.
   *
   * @param row
   * @param byteCount
   * @return
  ...
  /**
   * Deserializes the per row guidePosts info from the value part of each cell
   * in the SYSTEM.STATS table
   *
   * @param buf
   * @param offset
   * @param l
   ...
   * <br> u - [guidepostSize][guidePostsArray],[guidePostsSize][guidePostArray]
   *
