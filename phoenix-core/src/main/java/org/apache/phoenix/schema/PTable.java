...
public interface PTable extends PMetaDataEntity {
   ...
   *
   * @return the name of the data table that this index is on or null if not an
   * index.
   */
  PName getParentName();
   ...
   *
   * @return the table name of the data table that this index is on or null if
   * not an index.
   */
   ...
   *
   * @return the schema name of the data table that this index is on or null if
   * not an index.
   */
