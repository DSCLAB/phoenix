...
public class ParseNodeFactory {
  ...
  /**
   *
   * Key used to look up a built-in function using the combination of the
   * lowercase name and the number of arguments. This disambiguates the
   * aggregate MAX(<col>) from the non aggregate MAX(<col1>,<col2>).
   *
   *
   * @since 0.1
   */
  public static class BuiltInFunctionKey {
    ...
    public boolean equals(Object obj) {
      ...
      if (!upperName.equals(other.upperName)) {
        return false;
      }
      return true;
    }
  ...
  /**
   * Reflect this class and populate static structures from it. Don't initialize
   * in static block because we have a circular dependency
   */
