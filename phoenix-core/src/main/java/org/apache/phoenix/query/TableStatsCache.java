 ...
 * Intended to decouple Phoenix from a specific version of Guava's cache.
 */
public class TableStatsCache {
  ...
  /**
   * Returns the underlying cache. Try to use the provided methods instead of
  ...
  /**
   * A {@link RemovalListener} implementation to track evictions from the table
   * stats cache.
   */
