 ...
 *
 * <p>
 * Chunking is deprecated and shouldn't be used while implementing new features.
 * As of HBase 0.98.17, we rely on pacing the server side scanners instead of
 * pulling rows from the server in chunks.
 * </p>
 */
@Deprecated
public class ChunkedResultIterator implements PeekingResultIterator {
   ...
   * instead of pulling rows from the server in chunks.
   */
  @Deprecated
