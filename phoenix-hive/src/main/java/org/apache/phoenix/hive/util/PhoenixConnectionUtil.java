...
public class PhoenixConnectionUtil {
  ...
  public static Connection getInputConnection(final Configuration conf, final Properties props)
    ...
    quorum = quorum == null ? props.getProperty(PhoenixStorageHandlerConstants.ZOOKEEPER_QUORUM, PhoenixStorageHandlerConstants.DEFAULT_ZOOKEEPER_QUORUM)
            : quorum;
    ...
    zNodeParent = zNodeParent == null ? props.getProperty(PhoenixStorageHandlerConstants.ZOOKEEPER_PARENT, PhoenixStorageHandlerConstants.DEFAULT_ZOOKEEPER_PARENT)
            : zNodeParent;
