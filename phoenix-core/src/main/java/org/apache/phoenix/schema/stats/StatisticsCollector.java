 ...
 * stats like min key, max key and guideposts. TODO: review timestamps used for
 * stats. We support the user controlling the timestamps, so we should honor
 * that with timestamps for stats as well. The issue is for compaction, though.
 * I don't know of a way for the user to specify any timestamp for that. Perhaps
 * best to use current time across the board for now.
 */
public class StatisticsCollector {
  ...
  /**
   * Update the current statistics based on the latest batch of key-values from
